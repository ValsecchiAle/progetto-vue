# progetto-vue
🎮 Game Explorer — Vue + RAWG API + YouTube API

Un’applicazione realizzata con Vue.js che permette di esplorare videogiochi tramite la API di RAWG, visualizzarne dettagli completi e cercare automaticamente il trailer ufficiale su YouTube.
